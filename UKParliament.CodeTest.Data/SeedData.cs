...
namespace UKParliament.CodeTest.Data
{
    public static class SeedData
    {
        ...
        {
            new Person { Id = 1, FirstName = "Gaberial", LastName = "Smith", Description = "HR Specialist", DepartmentId = 1, DOB = new DateOnly(2001, 1, 26) },
            new Person { Id = 2, FirstName = "David", LastName = "Brown", Description = "HR Specialist", DepartmentId = 3, DOB = new DateOnly(1977, 6, 26) },
            new Person { Id = 3, FirstName = "Mike", LastName = "Jones", Description = "HR Specialist", DepartmentId = 4, DOB = new DateOnly(1985, 3, 20) },
            new Person { Id = 4, FirstName = "Ricky", LastName = "White", Description = "Analyst", DepartmentId = 1, DOB = new DateOnly(1999, 7, 10) },
            new Person { Id = 5, FirstName = "Sarah", LastName = "Johnson", Description = "Analyst", DepartmentId = 2, DOB = new DateOnly(1995, 2, 15) },
            ...
            new Person { Id = 38, FirstName = "Kaitlyn", LastName = "Sanchez", Description = "IT Analyst", DepartmentId = 9, DOB = new DateOnly(1998, 1, 3) },
